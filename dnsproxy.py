...
class DNSProxy:
    ...
    def handle_dns_query(self, client_query):
        ...
        if client_query[DNSQR].qname.decode() in mapred: #si esta mapeada la query se genera la respuesta predeterminada
    ...
    def start_dns_proxy(self):
        ...
        while True:
            ...
            self.handle_dns_query(client_query, remote_dns_ip, mapred)
