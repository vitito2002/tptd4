...
if __name__ == "__main__":
    ...
    dns_proxy_server = DNSProxy(remote_dns_ip, mapred)#Se crea una instancia de la clase DNSProxyServer pasando la dirección IP del servidor DNS remoto y los mapeos predeterminados.
